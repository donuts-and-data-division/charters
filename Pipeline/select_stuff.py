...
def select_statement():
    ...
    string = """
        SELECT ca_to_nces."CDSCode", "NCESCode", "closeddate", "zip", "fundingtype", "soctype", "eilname", "gsoffered", "latitude", "longitude"
        FROM ca_pubschls_new
        JOIN ca_to_nces
        ON ca_to_nces."CDSCode" = ca_pubschls_new.cdscode
        ;"""
